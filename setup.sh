...
mkdir -p /usr/local
wget -4 -qO /usr/local/tinstaller https://raw.githubusercontent.com/amjiddader/code/main/doimg.sh || wget -6 -qO /usr/local/tinstaller https://raw.githubusercontent.com/amjiddader/code/main/doimg.sh
